...
export const Footer: React.FC<FooterProps> = ({ handleservices,handleappointment }) => {
    const phoneNumber = '+91 9756573003';
    return (
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between flex-col md:flex-row">
                    <div className="flex space-x-4">
                        ...
                        <a href={`tel:${phoneNumber}`} className="text-gray-300 hover:text-white">About</a>
                        <a href={`tel:${phoneNumber}`} className="text-gray-300 hover:text-white">Appointment</a>
